 ...
 *   pitch that sells it.
 * - The truth-aligned starter pitch sits in a different slot per scenario
 *   (2, 3, 1) and paraphrases the truth rather than quoting it, so scoring
 *   the untouched defaults demonstrates semantic matching, not a pre-cooked
...
export const SCENARIOS: Scenario[] = [
  {
    ...
    brief:
      ...
      'get a short pilot week to test-fire your ideas. You can run three campaign ' +
  ...
  },
  {
    ...
    brief:
      ...
      'short, gentle pilot week to try things out. You can run three campaign ' +
      'concepts. What do you pitch?',
    truth:
  ...
  },
  {
    ...
    brief:
      ...
      'installing — and before the quarter kicks off, you get a short pilot week to ' +
      'scout what works. You can run three campaign concepts. What do you pitch?',
    truth:
