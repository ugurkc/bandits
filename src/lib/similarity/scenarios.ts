...
export const SCENARIOS: Scenario[] = [
  {
    ...
    brief:
      ...
      'campaign actually gets people installing — and before it starts, five pilot ' +
      'weeks to test-fire your ideas. You can run three campaign concepts. What do ' +
      'you pitch?',
    truth:
  ...
  },
  {
    ...
    brief:
      ...
      'actually gets people installing — and before it starts, five gentle pilot ' +
      'weeks to try things out. You can run three campaign concepts. What do you ' +
      'pitch?',
    truth:
  ...
  },
  {
    ...
    brief:
      ...
      'installing — and before it kicks off, five pilot weeks to scout what works. ' +
      'You can run three campaign concepts. What do you pitch?',
    truth:
